...
{\bf  Параметры}
  \begin{itemize}
   \item{
\texttt{placeSelect} -- компонент со списком городов ( Порядок городов должен соответсвовать порядку в \texttt{ Cities}{ 
...
Формат документа\mbox{}\newline \texttt{ \{\ ip : string, count : integer\}}}
...
\subsubsection*{Реализуют}{MongoVisitorsDataService{\refdefined{com.xotonic.dashboard.visitors.MongoVisitorsDataService}}}
\subsubsection*{Методы}{
\vskip -2em
\begin{itemize}
\item{ 
...
Формат документа\mbox{}\newline \texttt{ \{\ ip : string, count : integer\}}\vskip .1in 
\subsubsection*{Объявление}{
\begin{lstlisting}[frame=none]
...
\begin{enumerate}
  ...
  \item The MongoDB 3.2 Manual: [Электронный ресурс]. URL: https://docs.mongodb.com /v3.2/. (Дата обращения: 25.12.2016).
  \item Java™ Platform Standard Ed. 8: [Электронный ресурс]. URL: https://docs.oracle.com /javase/8/docs/api/. (Дата обращения: 27.12.2016).
  \item Java Platform Standard Edition 8 Documentation: [Электронный ресурс]. URL: https://docs.oracle.com/javase/8/docs/. (Дата обращения: 23.12.2016).
